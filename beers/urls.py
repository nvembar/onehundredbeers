...
urlpatterns = [
    ...
    url(r'^contests/(?P<contest_id>[0-9]+)/$', contest.contest, name='contest'),
    url(r'^contests/(?P<contest_id>[0-9]+)/join$', contest.contest_join, name='contest-join'),
    ...
    url(r'^contests/(?P<contest_id>[0-9]+)/players/(?P<username>[^/]+)$', contest.contest_player, name='player-detail'),
    url(r'^contests/(?P<contest_id>[0-9]+)/beers/(?P<beer_id>[0-9]+)$', contest.contest_beer, name='beer-detail'),
    url(r'^contests/(?P<contest_id>[0-9]+)/beers/$', contest.contest_beers, name='beer-list'),
    url(r'^contests/(?P<contest_id>[0-9]+)/leaderboard/$', contest.contest_leaderboard, name='leaderboard'),
