...
urlpatterns = [
    ...
    url(r'^contests/(?P<contest_id>[0-9]+)/validate/(?P<uv_checkin>[0-9]+)/update$',
        validation.update_checkin,
        name='update-checkin'),
    ...
    url(r'^contests/(?P<contest_id>[0-9]+)/beers/$',
        ...
        name='beer-list'),
    url(r'^contests/(?P<contest_id>[0-9]+)/leaderboard/$',
        contest.contest_leaderboard,
        name='leaderboard'),
